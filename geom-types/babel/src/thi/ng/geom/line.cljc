...
(scale
 ...
 ([_ sx sy sz]
    (thi.ng.geom.types.LineStrip2. (mapv #(g/* % sx sy sz) (:points _)))))
(scale-size
 [_ s] (thi.ng.geom.types.LineStrip2. (gu/scale-size s (:points _))))
g/PTranslate
(translate
 [_ t]
...
(scale
 ...
 ([_ sx sy sz]
    (thi.ng.geom.types.LineStrip3. (mapv #(g/* % sx sy sz) (:points _)))))
(scale-size
 [_ s] (thi.ng.geom.types.LineStrip3. (gu/scale-size s (:points _))))
g/PTranslate
(translate
 [_ t]
