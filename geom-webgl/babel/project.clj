(defproject thi.ng/geom-webgl "0.0.921"
  ...
  :cljsbuild {:builds [{:source-paths ["src" "test"]
                        :id "simple"
                        :compiler {:output-to "target/geom-webgl-0.0.921.js"
                       ...
                       {:source-paths ["src" "test"]
                        ...
                        :compiler {:output-to "target/geom-webgl-0.0.921.js"
                                   ...
                                   :pretty-print false}}]
              :test-commands {"unit-tests" ["phantomjs" :runner "target/geom-webgl-0.0.921.js"]}}
